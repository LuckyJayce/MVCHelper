...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public final boolean onTouchEvent(MotionEvent event) {
		...
		if (this instanceof PullToRefreshListView) {
	...
	@Override
	public void showHeadRefreshing() {
		showRefreshing(true);
	}

	@Override
	public void showFootRefrenshing() {
		showRefreshing(false);
	}

	private void showRefreshing(boolean isHeadRefreshing) {
		if (isHeadRefreshing) {
